...
import {
  getTractorEmployee,
  getTractorEmployeeDates,
  getTractorEmployeeTransactions,
} from "@/lib/actions/tractor-employee";
import { EditTractorEmployeeTransaction } from "@/components/tractor/tractor-worker/edit-transaction";
import { DeleteTractorEmployeeTransaction } from "@/components/tractor/tractor-worker/delete-transaction";

export default async function TractorEmployeePage({
  params,
  searchParams,
}: {
  ...
  const transactions = await getTractorEmployeeTransactions(id, year, month);
  const yearsAndMonths = await getTractorEmployeeDates(id);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <BackLink href="/tractor/tractor-workers" linkText="Back to Workers" />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <PrintTransactionReport
            title="Tractor Employee Transaction Report"
          ...
          <Button asChild>
            <Link
              href={`/tractor/tractor-workers/${employee._id}/add-transaction`}
            >
              Add Transaction
            </Link>
          </Button>
      ...
      {transactions.length > 0 ? (
            ...
            {transactionsWithBalance.map((transaction) => (
              <TableRow key={transaction._id}>
                ...
                <TableCell className="flex gap-3 items-center justify-center">
                  <EditTractorEmployeeTransaction
                    employeeId={id}
                    transaction={{
                      _id: transaction._id,
                  ...
                  />
                  <DeleteTractorEmployeeTransaction
        ...
        <EmptyState
          ...
          description="Start by adding your first tractor worker transaction"
          link={`/tractor/tractor-workers/${employee._id}/add-transaction`}
