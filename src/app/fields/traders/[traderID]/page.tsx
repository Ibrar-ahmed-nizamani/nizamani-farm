...
import {
  getFieldTrader,
  getFieldTraderDates,
  getFieldTraderTransactions,
} from "@/lib/actions/field-trader";
...
import { DeleteTraderTransaction } from "@/components/fields/traders/delete-trader-transaction";
import { EditTraderTransaction } from "@/components/fields/traders/edit-trader-transaction";
...
export default async function TraderPage({
  ...
  const transactions = await getFieldTraderTransactions(id, year, month);
  const yearsAndMonths = await getFieldTraderDates(id);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <BackLink href="/fields/traders" linkText="Back to Traders" />
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <Button asChild>
            <Link href={`/fields/traders/${id}/add-transaction`}>
              Add Transaction
            </Link>
          </Button>
        </div>
      ...
      {transactions.length > 0 ? (
        ...
        <EmptyState
          ...
          link={`/fields/traders/${id}/add-transaction`}
