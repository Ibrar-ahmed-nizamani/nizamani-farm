// components/field/farmer/edit-farmer-transaction.tsx
"use client";
...
import { updateFarmerTransaction } from "@/lib/actions/farmer";
...
interface EditFarmerTransactionProps {
  fieldId: string;
  farmerId: string;
