// components/milk/worker/edit-transaction.tsx
"use client";
...
import { updateMilkTraderTransaction } from "@/lib/actions/milk-trader";
...
export function EditTraderTransaction({
  traderId,
  transaction,
  ...
  const handleSubmit = async (values: EditTransactionFormData) => {
    await updateMilkTraderTransaction(
      traderId,
      transaction._id,
      values.type,
      values.amount,
